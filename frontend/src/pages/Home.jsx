...
const features = [
  { icon: Search, title: "College Discovery", desc: "Browse thousands of colleges by course, location, fees, and ranking to find the options that truly match your goals." },
  { icon: SlidersHorizontal, title: "Smart College Comparison", desc: "Compare colleges side-by-side on fees, placements, ratings, and facilities to make a confident, informed decision." },
  { icon: Sparkles, title: "AI Recommendations", desc: "Get personalized college suggestions based on your marks, interests, and budget — powered by smart AI matching." },
  { icon: FileText, title: "Detailed College Profiles", desc: "Access in-depth profiles covering courses, cutoffs, faculty, infrastructure, and verified student reviews." },
];
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {features.map(({ icon: Icon, title, desc }) => (
          <div
            key={title}
            className="group rounded-2xl border border-slate-100 bg-white p-6 shadow-[0_1px_3px_rgba(15,23,42,0.06)] transition-shadow hover:shadow-[0_8px_24px_rgba(15,23,42,0.08)]"
          >
...
const steps = [
  { icon: Search, title: "Search Colleges", desc: "Tell us your course, location, and budget preferences to start your search." },
  { icon: Scale, title: "Compare Options", desc: "Shortlist colleges and compare them side-by-side across key metrics." },
  { icon: CheckCircle2, title: "Choose the Best Fit", desc: "Use AI recommendations and verified reviews to make your final decision." },
];
...
const CollegeCard = ({ college, onNavigate }) => (
...
const PopularColleges = ({ onNavigate }) => (
  <section className="bg-white py-20 sm:py-24">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          <SectionLabel>Trending This Month</SectionLabel>
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            Popular Colleges
          </h2>
        </div>
      ...
      <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {colleges.map((c) => (
          <CollegeCard key={c.name} college={c} onNavigate={onNavigate} />
        ))}
      </div>
    </div>
  </section>
...
const WhyChooseUs = () => (
  <section className="bg-gradient-to-b from-white to-blue-50/50 py-20 sm:py-24">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <SectionLabel>Trusted by Students</SectionLabel>
        <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
...
const testimonials = [
  { name: "Ananya Sharma", role: "B.Tech, IIT Delhi", quote: "College Compass made shortlisting colleges so much easier. The comparison tool saved me weeks of research and helped me pick with confidence.", initials: "AS" },
  { name: "Rohan Mehta", role: "BBA, Christ University", quote: "The AI recommendations were spot on for my budget and interests. I found colleges I hadn't even considered before using the platform.", initials: "RM" },
  { name: "Priya Nair", role: "B.Com, Symbiosis", quote: "Genuine student reviews gave me the real picture beyond brochures. It's now the first place I recommend to juniors planning their college search.", initials: "PN" },
];
...
export default function Home({ onNavigate }) {
  return (
    <>
      ...
      <Features />
      <HowItWorks />
      <PopularColleges onNavigate={onNavigate} />
      <WhyChooseUs />
      <Testimonials />
